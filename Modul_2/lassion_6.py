...
def get_shifr(n):
    shifr = {}
    shifr.update({3: 12, 4: 13, 5:1423, 6:121524,7:162534,8:13172635,9:1218273645})
    shifr.update({10:141923283746,11:11029384756,12:12131511124210394857, 13:112211310495867})
    shifr.update({14:1611325212343114105968,15:1214114232133124115106978})
    shifr.update({16:1317115262143531341251161079, 17:11621531441351261171089})
    shifr.update({18:12151811724272163631545414513612711810,19:118217316415514613712811910})
    shifr.update({20:13141911923282183731746416515614713812911})
    passcode = shifr.get(n)
    return passcode
